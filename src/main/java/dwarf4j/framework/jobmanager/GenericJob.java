...
public abstract class GenericJob extends org.springframework.scheduling.quartz.QuartzJobBean {
  ...
  public GenericJob() {
    ...
    this.idExecucao = dwarf4j.utils.LogicUtils.getInstance().string2MD5(
  ...
  public dwarf4j.framework.jobmanager.Prioridade prioridade() { return dwarf4j.framework.jobmanager.Prioridade.NORMAL; }
